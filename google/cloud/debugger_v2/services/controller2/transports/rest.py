...
class Controller2RestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def pre_list_active_breakpoints(
        self,
        request: controller.ListActiveBreakpointsRequest,
        metadata: Sequence[Tuple[str, str]],
    ) -> Tuple[controller.ListActiveBreakpointsRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_list_active_breakpoints(
        self, response: controller.ListActiveBreakpointsResponse
    ...
    def pre_register_debuggee(
        self,
        request: controller.RegisterDebuggeeRequest,
        metadata: Sequence[Tuple[str, str]],
    ) -> Tuple[controller.RegisterDebuggeeRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_register_debuggee(
        self, response: controller.RegisterDebuggeeResponse
    ...
    def pre_update_active_breakpoint(
        self,
        request: controller.UpdateActiveBreakpointRequest,
        metadata: Sequence[Tuple[str, str]],
    ) -> Tuple[controller.UpdateActiveBreakpointRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_update_active_breakpoint(
        self, response: controller.UpdateActiveBreakpointResponse
    ...
    class _ListActiveBreakpoints(Controller2RestStub):
        ...
        def __call__(
            ...
            *,
            ...
            request, metadata = self._interceptor.pre_list_active_breakpoints(
                request, metadata
            )
    ...
    class _RegisterDebuggee(Controller2RestStub):
        ...
        def __call__(
            ...
            *,
            ...
            request, metadata = self._interceptor.pre_register_debuggee(
                request, metadata
            )
    ...
    class _UpdateActiveBreakpoint(Controller2RestStub):
        ...
        def __call__(
            ...
            *,
            ...
            request, metadata = self._interceptor.pre_update_active_breakpoint(
                request, metadata
            )
...
__all__ = ("Controller2RestTransport",)
