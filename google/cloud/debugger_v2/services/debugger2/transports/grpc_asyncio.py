...
class Debugger2GrpcAsyncIOTransport(Debugger2Transport):
    ...
    def set_breakpoint(
        ...
        [debugger.SetBreakpointRequest], Awaitable[debugger.SetBreakpointResponse]
    ]:
    ...
    def get_breakpoint(
        ...
        [debugger.GetBreakpointRequest], Awaitable[debugger.GetBreakpointResponse]
    ]:
    ...
    def delete_breakpoint(
        self,
    ) -> Callable[[debugger.DeleteBreakpointRequest], Awaitable[empty_pb2.Empty]]:
    ...
    def list_breakpoints(
        ...
        [debugger.ListBreakpointsRequest], Awaitable[debugger.ListBreakpointsResponse]
    ]:
    ...
    def list_debuggees(
        ...
        [debugger.ListDebuggeesRequest], Awaitable[debugger.ListDebuggeesResponse]
    ]:
