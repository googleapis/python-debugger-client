...
def test__get_default_mtls_endpoint():
    ...
    assert (
        Controller2Client._get_default_mtls_endpoint(api_endpoint) == api_mtls_endpoint
    )
    assert (
        Controller2Client._get_default_mtls_endpoint(api_mtls_endpoint)
        == api_mtls_endpoint
    )
    assert (
        Controller2Client._get_default_mtls_endpoint(sandbox_endpoint)
        == sandbox_mtls_endpoint
    )
    assert (
        Controller2Client._get_default_mtls_endpoint(sandbox_mtls_endpoint)
        == sandbox_mtls_endpoint
    )
...
@mock.patch.object(
    Controller2AsyncClient,
    "DEFAULT_ENDPOINT",
    modify_default_endpoint(Controller2AsyncClient),
)
...
def test_controller2_client_mtls_env_auto(
    client_class, transport_class, transport_name, use_client_cert_env
):
...
def test_controller2_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.debugger_v2.services.controller2.transports.Controller2GrpcTransport.__init__"
    ) as grpc_transport:
        grpc_transport.return_value = None
        client = Controller2Client(client_options={"api_endpoint": "squid.clam.whelk"})
...
def test_register_debuggee(request_type, transport: str = "grpc"):
    ...
    with mock.patch.object(
        type(client.transport.register_debuggee), "__call__"
    ) as call:
...
@pytest.mark.asyncio
async def test_register_debuggee_async(
    transport: str = "grpc_asyncio", request_type=controller.RegisterDebuggeeRequest
):
...
def test_register_debuggee_flattened():
    client = Controller2Client(credentials=ga_credentials.AnonymousCredentials(),)
...
async def test_register_debuggee_flattened_async():
    client = Controller2AsyncClient(credentials=ga_credentials.AnonymousCredentials(),)
...
def test_list_active_breakpoints(request_type, transport: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        call.return_value = controller.ListActiveBreakpointsResponse(
            next_wait_token="next_wait_token_value", wait_expired=True,
        )
...
@pytest.mark.asyncio
async def test_list_active_breakpoints_async(
...
def test_list_active_breakpoints_flattened():
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        client.list_active_breakpoints(debuggee_id="debuggee_id_value",)
...
def test_list_active_breakpoints_flattened_error():
    ...
    with pytest.raises(ValueError):
        client.list_active_breakpoints(
            controller.ListActiveBreakpointsRequest(), debuggee_id="debuggee_id_value",
        )
...
@pytest.mark.asyncio
async def test_update_active_breakpoint_async(
    transport: str = "grpc_asyncio",
...
def test_credentials_transport_error():
    ...
    with pytest.raises(ValueError):
        client = Controller2Client(client_options=options, transport=transport,)
...
@pytest.mark.parametrize(
    "transport_class",
    [transports.Controller2GrpcTransport, transports.Controller2GrpcAsyncIOTransport,],
)
...
def test_transport_grpc_default():
    ...
    client = Controller2Client(credentials=ga_credentials.AnonymousCredentials(),)
    assert isinstance(client.transport, transports.Controller2GrpcTransport,)
...
def test_controller2_base_transport():
    ...
    with mock.patch(
        "google.cloud.debugger_v2.services.controller2.transports.Controller2Transport.__init__"
    ) as Transport:
...
def test_controller2_base_transport_with_credentials_file():
    ...
    with mock.patch.object(
        ...
        "google.cloud.debugger_v2.services.controller2.transports.Controller2Transport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None
...
def test_controller2_grpc_transport_client_cert_source_for_mtls(transport_class):
...
def test_controller2_transport_channel_mtls_with_client_cert_source(transport_class):
    with mock.patch(
...
def test_controller2_transport_channel_mtls_with_adc(transport_class):
    mock_ssl_cred = mock.Mock()
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(
        transports.Controller2Transport, "_prep_wrapped_messages"
    ) as prep:
        client = Controller2Client(
