...
from google.cloud.debugger_v2.services.debugger2 import (
...
def test__get_default_mtls_endpoint():
    ...
    assert (
        Debugger2Client._get_default_mtls_endpoint(api_mtls_endpoint)
        == api_mtls_endpoint
    )
    assert (
        Debugger2Client._get_default_mtls_endpoint(sandbox_endpoint)
        == sandbox_mtls_endpoint
    )
    assert (
        Debugger2Client._get_default_mtls_endpoint(sandbox_mtls_endpoint)
        == sandbox_mtls_endpoint
    )
...
def test_debugger2_client_service_account_always_use_jwt(
    transport_class, transport_name
):
    with mock.patch.object(
...
@mock.patch.object(
    Debugger2Client, "DEFAULT_ENDPOINT", modify_default_endpoint(Debugger2Client)
)
@mock.patch.object(
    Debugger2AsyncClient,
    "DEFAULT_ENDPOINT",
    modify_default_endpoint(Debugger2AsyncClient),
)
...
def test_debugger2_client_mtls_env_auto(
    client_class, transport_class, transport_name, use_client_cert_env
):
...
def test_debugger2_client_client_options_scopes(
    client_class, transport_class, transport_name
):
...
def test_debugger2_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.debugger_v2.services.debugger2.transports.Debugger2GrpcTransport.__init__"
    ) as grpc_transport:
        grpc_transport.return_value = None
        client = Debugger2Client(client_options={"api_endpoint": "squid.clam.whelk"})
...
@pytest.mark.asyncio
async def test_set_breakpoint_async(
...
@pytest.mark.asyncio
async def test_get_breakpoint_async(
...
def test_delete_breakpoint(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
        type(client.transport.delete_breakpoint), "__call__"
    ) as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_delete_breakpoint_async(
...
@pytest.mark.asyncio
async def test_list_breakpoints_async(
...
@pytest.mark.asyncio
async def test_list_debuggees_async(
...
def test_set_breakpoint_rest(request_type):
    ...
    request_init["breakpoint_"] = {
        "id": "id_value",
        "action": 1,
        "location": {"path": "path_value", "line": 424, "column": 654},
        "condition": "condition_value",
        "expressions": ["expressions_value1", "expressions_value2"],
        "log_message_format": "log_message_format_value",
        "log_level": 1,
        "is_final_state": True,
        ...
        "status": {
            ...
            "description": {
                ...
                "parameters": ["parameters_value1", "parameters_value2"],
            },
        },
        "stack_frames": [
            {
...
def test_set_breakpoint_rest_required_fields(
    request_type=debugger.SetBreakpointRequest,
):
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).set_breakpoint._get_unset_required_fields(jsonified_request)
...
def test_set_breakpoint_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        transports.Debugger2RestInterceptor, "post_set_breakpoint"
    ) as post, mock.patch.object(
        transports.Debugger2RestInterceptor, "pre_set_breakpoint"
    ) as pre:
        ...
        req.return_value._content = debugger.SetBreakpointResponse.to_json(
            debugger.SetBreakpointResponse()
        )
...
def test_set_breakpoint_rest_bad_request(
    transport: str = "rest", request_type=debugger.SetBreakpointRequest
):
    client = Debugger2Client(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_set_breakpoint_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v2/debugger/debuggees/{debuggee_id}/breakpoints/set"
...
def test_get_breakpoint_rest_required_fields(
    request_type=debugger.GetBreakpointRequest,
):
    transport_class = transports.Debugger2RestTransport
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).get_breakpoint._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_breakpoint_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        transports.Debugger2RestInterceptor, "post_get_breakpoint"
    ) as post, mock.patch.object(
        transports.Debugger2RestInterceptor, "pre_get_breakpoint"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = debugger.GetBreakpointResponse.to_json(
            debugger.GetBreakpointResponse()
        )
...
def test_get_breakpoint_rest_bad_request(
    transport: str = "rest", request_type=debugger.GetBreakpointRequest
):
    client = Debugger2Client(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_get_breakpoint_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2/debugger/debuggees/{debuggee_id}/breakpoints/{breakpoint_id}"
            % client.transport._host,
            args[1],
        )
...
def test_delete_breakpoint_rest_required_fields(
    request_type=debugger.DeleteBreakpointRequest,
):
    transport_class = transports.Debugger2RestTransport
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).delete_breakpoint._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_breakpoint_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        transports.Debugger2RestInterceptor, "pre_delete_breakpoint"
    ) as pre:
        pre.assert_not_called()
        pb_message = debugger.DeleteBreakpointRequest.pb(
            debugger.DeleteBreakpointRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_delete_breakpoint_rest_bad_request(
    transport: str = "rest", request_type=debugger.DeleteBreakpointRequest
):
    client = Debugger2Client(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_list_breakpoints_rest_required_fields(
    request_type=debugger.ListBreakpointsRequest,
):
    transport_class = transports.Debugger2RestTransport
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).list_breakpoints._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_breakpoints_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        transports.Debugger2RestInterceptor, "post_list_breakpoints"
    ) as post, mock.patch.object(
        transports.Debugger2RestInterceptor, "pre_list_breakpoints"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = debugger.ListBreakpointsRequest.pb(
            debugger.ListBreakpointsRequest()
        )
        transcode.return_value = {
            "method": "post",
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = debugger.ListBreakpointsResponse.to_json(
            debugger.ListBreakpointsResponse()
        )
...
def test_list_breakpoints_rest_bad_request(
    transport: str = "rest", request_type=debugger.ListBreakpointsRequest
):
    client = Debugger2Client(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_list_breakpoints_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2/debugger/debuggees/{debuggee_id}/breakpoints"
            % client.transport._host,
            args[1],
        )
...
def test_list_debuggees_rest_required_fields(
    request_type=debugger.ListDebuggeesRequest,
):
    transport_class = transports.Debugger2RestTransport
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).list_debuggees._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_debuggees_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        transports.Debugger2RestInterceptor, "post_list_debuggees"
    ) as post, mock.patch.object(
        transports.Debugger2RestInterceptor, "pre_list_debuggees"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = debugger.ListDebuggeesResponse.to_json(
            debugger.ListDebuggeesResponse()
        )
...
def test_list_debuggees_rest_bad_request(
    transport: str = "rest", request_type=debugger.ListDebuggeesRequest
):
    client = Debugger2Client(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_list_debuggees_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2/debugger/debuggees" % client.transport._host, args[1]
        )
...
def test_debugger2_base_transport():
    ...
    with mock.patch(
        "google.cloud.debugger_v2.services.debugger2.transports.Debugger2Transport.__init__"
    ) as Transport:
...
def test_debugger2_base_transport_with_credentials_file():
    ...
    with mock.patch.object(
        ...
        "google.cloud.debugger_v2.services.debugger2.transports.Debugger2Transport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None
...
def test_debugger2_grpc_transport_client_cert_source_for_mtls(transport_class):
...
def test_debugger2_transport_channel_mtls_with_client_cert_source(transport_class):
    with mock.patch(
...
def test_debugger2_transport_channel_mtls_with_adc(transport_class):
    mock_ssl_cred = mock.Mock()
