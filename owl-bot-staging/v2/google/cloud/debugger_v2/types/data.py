...
class Debuggee(proto.Message):
    ...
    Attributes:
        ...
        source_contexts (MutableSequence[google.devtools.source.v1.source_context_pb2.SourceContext]):
            References to the locations and revisions of
            the source code used in the deployed
            application.
        ext_source_contexts (MutableSequence[google.devtools.source.v1.source_context_pb2.ExtendedSourceContext]):
            References to the locations and revisions of
            the source code used in the deployed
            application.
        labels (MutableMapping[str, str]):
    ...
    source_contexts: MutableSequence[source_context_pb2.SourceContext] = proto.RepeatedField(
        proto.MESSAGE,
        number=9,
        message=source_context_pb2.SourceContext,
    )
    ext_source_contexts: MutableSequence[source_context_pb2.ExtendedSourceContext] = proto.RepeatedField(
        proto.MESSAGE,
        number=13,
