...
def test_controller2_client_service_account_always_use_jwt(transport_class, transport_name):
...
@pytest.mark.parametrize("client_class", [
    Controller2Client, Controller2AsyncClient
])
@mock.patch.object(Controller2Client, "DEFAULT_ENDPOINT", modify_default_endpoint(Controller2Client))
@mock.patch.object(Controller2AsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(Controller2AsyncClient))
def test_controller2_client_get_mtls_endpoint_and_cert_source(client_class):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    ...
    (Controller2AsyncClient, transports.Controller2GrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
    (Controller2Client, transports.Controller2RestTransport, "rest", None),
])
def test_controller2_client_client_options_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
...
def test_controller2_client_create_channel_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(
        credentials_file="credentials.json"
    )
...
def test_register_debuggee_flattened():
    ...
    with mock.patch.object(
        ...
        _, args, _ = call.mock_calls[0]
        arg = args[0].debuggee
        mock_val = data.Debuggee(id='id_value')
        assert arg == mock_val
...
def test_register_debuggee_rest_required_fields(request_type=controller.RegisterDebuggeeRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).register_debuggee._get_unset_required_fields(jsonified_request)
...
def test_register_debuggee_rest_unset_required_fields():
    transport = transports.Controller2RestTransport(credentials=ga_credentials.AnonymousCredentials)
...
def test_register_debuggee_rest_interceptors(null_interceptor):
    transport = transports.Controller2RestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.Controller2RestInterceptor(),
        )
    client = Controller2Client(transport=transport)
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.Controller2RestInterceptor, "post_register_debuggee") as post, \
         mock.patch.object(transports.Controller2RestInterceptor, "pre_register_debuggee") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = controller.RegisterDebuggeeRequest.pb(controller.RegisterDebuggeeRequest())
        ...
        req.return_value._content = controller.RegisterDebuggeeResponse.to_json(controller.RegisterDebuggeeResponse())
        ...
        client.register_debuggee(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_register_debuggee_rest_bad_request(transport: str = 'rest', request_type=controller.RegisterDebuggeeRequest):
    client = Controller2Client(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_register_debuggee_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v2/controller/debuggees/register" % client.transport._host, args[1])
...
def test_list_active_breakpoints_rest_required_fields(request_type=controller.ListActiveBreakpointsRequest):
    transport_class = transports.Controller2RestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_active_breakpoints._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    assert not set(unset_fields) - set(("success_on_timeout", "wait_token", ))
    jsonified_request.update(unset_fields)
...
def test_list_active_breakpoints_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("successOnTimeout", "waitToken", )) & set(("debuggeeId", )))
...
def test_list_active_breakpoints_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.Controller2RestInterceptor, "post_list_active_breakpoints") as post, \
         mock.patch.object(transports.Controller2RestInterceptor, "pre_list_active_breakpoints") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = controller.ListActiveBreakpointsRequest.pb(controller.ListActiveBreakpointsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = controller.ListActiveBreakpointsResponse.to_json(controller.ListActiveBreakpointsResponse())
        ...
        client.list_active_breakpoints(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_list_active_breakpoints_rest_bad_request(transport: str = 'rest', request_type=controller.ListActiveBreakpointsRequest):
    client = Controller2Client(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_active_breakpoints_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2/controller/debuggees/{debuggee_id}/breakpoints" % client.transport._host, args[1])
...
def test_update_active_breakpoint_rest_required_fields(request_type=controller.UpdateActiveBreakpointRequest):
    transport_class = transports.Controller2RestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_active_breakpoint._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_active_breakpoint_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("debuggeeId", "breakpoint", )))
...
def test_update_active_breakpoint_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.Controller2RestInterceptor, "post_update_active_breakpoint") as post, \
         mock.patch.object(transports.Controller2RestInterceptor, "pre_update_active_breakpoint") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = controller.UpdateActiveBreakpointRequest.pb(controller.UpdateActiveBreakpointRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = controller.UpdateActiveBreakpointResponse.to_json(controller.UpdateActiveBreakpointResponse())
        ...
        client.update_active_breakpoint(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_update_active_breakpoint_rest_bad_request(transport: str = 'rest', request_type=controller.UpdateActiveBreakpointRequest):
    client = Controller2Client(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_active_breakpoint_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2/controller/debuggees/{debuggee_id}/breakpoints/{breakpoint_.id}" % client.transport._host, args[1])
...
@pytest.mark.parametrize("client_class,transport_class", [
    (Controller2Client, transports.Controller2GrpcTransport),
    (Controller2AsyncClient, transports.Controller2GrpcAsyncIOTransport),
])
